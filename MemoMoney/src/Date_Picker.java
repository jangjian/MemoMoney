...
class DatePick {
    ...
    ImageIcon aBtn = new ImageIcon(MainFrame.class.getResource("../Image/001.png"));
    public DatePick(JFrame J_Frame_Parent) {
        ...
        J_Panel1.setPreferredSize(new Dimension(1280, 720));
...
public class Date_Picker {
	static JFrame J_Frame = new JFrame();
